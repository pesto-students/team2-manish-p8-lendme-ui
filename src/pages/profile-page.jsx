                ...
                <div className="profile-data">
                    <div className="details">
                        <div className="details-header">
                            ...
                            <div className="edit-btn">
                                <ButtonComponent className="edit-btn-comp" buttonText="Edit" style={{ backgroundColor: '#C0C0C0'}} variant="contained" onClickHandler={() => {}}/>
                            </div>
                        </div>
                    ...
                    <div className="change-password"> 
                        ...
                        <div className="change-pass-body">
                            ...
                            <ButtonComponent className="change-pass-btn" buttonText="Change Password" variant="contained" style={{ backgroundColor: '#047857'}} onClickHandler={() => {checkPassword()}}/>
                        </div>
